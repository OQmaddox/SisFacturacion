      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form role="form">
            ...
            <div class="form-group">
              <label for="sucursal">Dinero total en caja Apertura</label>
              <input type="text" class="form-control" id="cierre_caja_saldo" disabled>

            </div>
            <div class="form-group">
              <label for="sucursal">Dinero total en caja Cierre</label>
              <input type="text" class="form-control" id="cierre_caja_valor" onKeyPress="return filterFloat(event,this);" placeholder="$0.0">

            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-success" onclick="validarCierreCaja()">Aceptar</button>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form role="form">
              ...
              <div class="form-group">
                <label for="sucursal">Dinero total en caja Cierre</label>
                <input type="text" class="form-control" id="cierre_caja_valor_2" onKeyPress="return filterFloat(event,this);" placeholder="$0.0">

              </div>
              <div class="modal-footer">
                <button type="submit" class="btn btn-success" onclick="validarCierreCaja_2()">Aceptar</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
              </div>
            </form>
          </div>
