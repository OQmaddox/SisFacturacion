...
<body>
    ...
    <div class="ticket">
        <p class="centrado">
            <?= strtoupper($this->session->userdata('emp_nombre')) ?>

            <br class="centrado">Dir:<?= $this->session->userdata('emp_direccion') ?>
            <br>Tel:<?= $this->session->userdata('emp_telefono') ?>
            <br>Ruc:<?= $this->session->userdata('emp_ruc') ?><br>
            <br><?php echo $data1->CLI_NOMBRE ?> <?php echo $data1->CLI_APELLIDO ?>
            <br><?php echo $data1->CLI_CEDULA ?>
            <br><?php echo $data1->CLI_DIRECCION ?>
            <br><?php echo $data1->CLI_TELEFONO ?>
            <br><?= $this->session->userdata('emp_ciudad') ?>, <?php echo $data1->FAC_FECHA ?></p>
        <table>
            <thead>
                <tr>
