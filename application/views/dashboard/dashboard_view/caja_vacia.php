            ...
            <div class="modal-body">
                ...
                <form role="form">
                    <div class="form-group">
                        <label for="sucursal">Dinero total en caja</label>
                        <input type="text" class="form-control" id="apertura_caja_valor" onKeyPress="return filterFloat(event,this);" placeholder="$0.0">

                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" onclick="validarCaja()">Aceptar</button>
